 ...
 * @author VícAlex
 */
public class menuMasVendidos extends javax.swing.JFrame implements Runnable{
    ...
    public menuMasVendidos() {
        ...
        h1.start();
        xml = new Documento();
        tablaArticulos.setModel(xml.cantidadArticuloVendido());
        fieldMasVendido.setText(xml.articuloMasVendido());
    }
    
    public menuMasVendidos(ArrayList<Factura> facturas) {
    ...
    private void initComponents() {
        ...
        fieldMasVendido = new javax.swing.JTextField();
        ...
        txtDatos.setText("Lista de Articulos segun Cantidad de Ventas");

        txtDatos1.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        txtDatos1.setForeground(new java.awt.Color(255, 255, 255));
        txtDatos1.setText("Articulo mas Vendido");

        fieldMasVendido.setBackground(new java.awt.Color(16, 135, 61));
        fieldMasVendido.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        fieldMasVendido.setForeground(new java.awt.Color(255, 255, 255));
        fieldMasVendido.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(35, 155, 81)));
        fieldMasVendido.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                fieldMasVendidoKeyTyped(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(fieldMasVendido, javax.swing.GroupLayout.PREFERRED_SIZE, 411, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(fieldMasVendido, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(8, 8, 8)
    ...
    private void btnregresarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnregresarMouseReleased
        ...
        menuRegistro obj;
        try {
            obj = new menuRegistro();
            obj.setVisible(true);
        } catch (ParseException ex) {
            Logger.getLogger(menuMasVendidos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void fieldMasVendidoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fieldMasVendidoKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_fieldMasVendidoKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuMasVendidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menuMasVendidos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField fieldMasVendido;
